...
def get_slot_machine_spin(rows, cols, symbols):
    ...
    for _ in range(cols):
        column =[]
        current_symbols = all_symbols[:] # making a copy of all symbols, using [:] so that change in new list desnot affect previous list
        for _ in range(rows):
...
def spin(balance):
    ...
    print(f'YOU WON ON LINES: ', *winning_lines) # * this is unpack or splat operator
